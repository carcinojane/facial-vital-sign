"""
Quick test script to run PURE evaluation on a small subset
"""
import sys
import os
...
def main():
    ...
    print("Running PURE dataset evaluation on 3 subjects (quick test)...")

    # Run evaluation on first 3 subjects
    ...
    if results and results.get('results'):
        ...
        print(f"\n{'='*70}")
        print("Quick test complete! Results saved to results.txt")
        print(f"{'='*70}")
